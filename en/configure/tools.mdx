...
You'll find them under **Tools** in the sidebar.
...
When a conversation is escalated (by the AI), all **workspace owners** receive an email notification. The email includes a direct link to the conversation in the inbox.
