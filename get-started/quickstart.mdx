...
These settings affect how your agent looks to customers — you can always change them later under **Configure → Customize**.
...
A well-written system prompt makes a huge difference in quality. If you're not sure what to write yet, use one of the presets and refine it once you've seen the agent in action.
...
| **Widget & Playground** | Get your embed code, test the agent live |
...
**Next up:** [Configure → Customize](/configure/knowledge) — set your agent's name, colors, AI behavior, and content settings.