...
{/* 📸 SCREENSHOT: The Share Agent dialog open on the "Embed Widget" tab, showing the code snippet, position/language selectors, the copy button, and the CSP hint below it. */}
...
{/* 📸 SCREENSHOT: The Playground page — showing the chat interface in the app with a test conversation, the restart button visible in the header. */}
...
{/* 📸 SCREENSHOT: The inbox conversation list showing a mix of regular and playground conversations, with the flask icon clearly visible next to the playground ones. */}
...
{/* 📸 SCREENSHOT: The Share Agent dialog on the "Public Link" tab, showing the URL, the copy button, and the hint text ("Anyone with this link can chat with your AI assistant"). */}
